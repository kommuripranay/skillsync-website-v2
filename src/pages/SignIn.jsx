...
function SignIn() {
  ...
  /*useEffect(() => {
    // When the component mounts, hide page scrolling
    document.body.style.overflow = 'hidden';

    // When the component unmounts (you go to another page), reset it
    return () => {
      document.body.style.overflow = 'auto';
    };
  }, []);*/ // The empty array means this only runs on mount and unmount

  return (
    <div className="signin-container">
      <div className="signin-content">
        {/* 2. Replace text with img tag */}
        <Link to="/" className="signin-logo">
          <img src={logoImage} alt="SkillSync Logo" height="500" /> {/* Adjust height as needed */}
        </Link>
